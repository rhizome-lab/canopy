...
**Canopy:** A UI client for arbitrary data - static, filesystem, network fetched/streamed, video, audio, binary, JSON, SSE, JSONL, protobuf, msgpack, etc. Infinitely user-configurable.
